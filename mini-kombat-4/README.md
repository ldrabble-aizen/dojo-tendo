...
Esta version abre la etapa Mini Kombat IV, creada como secuela independiente desde Mini Kombat III, con soporte tactil para telefonos y una entrada Online preparada para conectar salas con Firebase.
...
```sh
http://127.0.0.1:8010/mini-kombat-4/index.html
```
...
- En telefono: girar a horizontal y usar el pad tactil + botones de ataque.
- `Online`: abre la pantalla de preparacion del modo online. Falta pegar la configuracion Firebase para activar salas reales.
- `firebase-config.example.js`: plantilla para crear `firebase-config.js` cuando activemos Firebase Realtime Database.
