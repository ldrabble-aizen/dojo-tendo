...
Esta version abre la etapa Mini Kombat III con soporte tactil para telefonos y una entrada Online preparada para conectar salas con Firebase.
...
```sh
http://127.0.0.1:8008/mini-kombat-3/index.html
```
